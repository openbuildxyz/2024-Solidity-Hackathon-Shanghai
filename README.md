...
1. Enter the official [GitHub](https://github.com/openbuildxyz/2024-Solidity-Hackathon-Shanghai) - `2024-Solidity-Hackathon-Shanghai` repository of the hackathon.
...
3. Clone the copy of the Forked repository to your device;
   ...
   ```
   git clone https://github.com/openbuildxyz/2024-Solidity-Hackathon-Shanghai.git
   ```
